var pxtTargetBundle = {
  "id": "holidays",
  "name": "MakeCode for the Holidays",
  "title": "MakeCode Holidays",
  "corepkg": "core",
  "cloud": {
    "workspace": false,
    "packages": false
  ...
  "appTheme": {
    ...
    "docMenu": [
      {
        "name": "About",
        "path": "/makecode-holiday/docs/about"
      },
      {
        "name": "Docs",
        "path": "/makecode-holiday/docs/docs"
      }
    ],
    "coloredToolbox": true,
    ...
    "blocklyColors": {
      "insertionMarker": "#9A6F62",
      "insertionMarkerOpacity": 0.5
    },
    "simAnimationEnter": "fly in right",
    "simAnimationExit": "fly out right",
    "allowParentController": true,
    "hideCookieNotice": true,
    "hideMenuBar": true,
    "hideEditorToolbar": true,
    "hideFlyoutHeadings": true,
    "extendEditor": true,
  ...
  "compile": {
    "onStartText": true,
    "emptyEventHandlerComments": true,
    "switches": {},
    "jsRefCounting": false,
    "vtableShift": 2,
